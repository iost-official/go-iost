...
var voteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return processMethod("vote_producer.iost", "vote", accountName, args[0], args[1])
	},
}
var unvoteCmd = &cobra.Command{
	...
	Args:    voteCmd.Args,
	RunE: func(cmd *cobra.Command, args []string) error {
		return processMethod("vote_producer.iost", "unvote", accountName, args[0], args[1])
	},
}
...
var registerCmd = &cobra.Command{
  ...
  iwallet sys register XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX --account test1 --location PEK --url iost.io --net_id 123 --partner`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "applyRegister", target, args[0], location, url, networkID, !isPartner)
	},
}
var unregisterCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "applyUnregister", target)
	},
}
var pcleanCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "unregister", target)
	},
}
...
var ploginCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "logInProducer", target)
	},
}
var plogoutCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "logOutProducer", target)
	},
}
...
var pupdateCmd = &cobra.Command{
  ...
  iwallet sys pupdate --account test2 --location PEK --url iost.io --net_id 123`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "updateProducer", target, publicKey, location, url, networkID)
	},
}
...
var predeemCmd = &cobra.Command{
  ...
  iwallet sys producer-redeem 10 --account test0`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("bonus.iost", "exchangeIOST", accountName, amount)
	},
}
...
var pwithdrawCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "candidateWithdraw", target)
	},
}
...
var vwithdrawCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return processMethod("vote_producer.iost", "voterWithdraw", target)
	},
}
