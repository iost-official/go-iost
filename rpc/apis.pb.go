...
func (*HashReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{0}
}
...
func (*BlockByHashReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{1}
}
...
func (*BlockByNumReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{2}
}
...
func (*GetBalanceReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{3}
}
...
func (*GetStateReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{4}
}
...
func (*RawTxReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{5}
}
...
func (*SubscribeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{6}
}
...
func (*HeightRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{7}
}
...
func (*GetAddressReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{8}
}
func (m *GetAddressReq) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetAddressReq) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetAddressReq.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *GetAddressReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetAddressReq.Merge(dst, src)
}
func (m *GetAddressReq) XXX_Size() int {
	return m.Size()
}
func (m *GetAddressReq) XXX_DiscardUnknown() {
	xxx_messageInfo_GetAddressReq.DiscardUnknown(m)
}

var xxx_messageInfo_GetAddressReq proto.InternalMessageInfo

func (m *GetAddressReq) GetPubKey() string {
	if m != nil {
		return m.PubKey
	}
	return ""
...
func (*GetAddressRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{9}
}
func (m *GetAddressRes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetAddressRes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetAddressRes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *GetAddressRes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetAddressRes.Merge(dst, src)
}
func (m *GetAddressRes) XXX_Size() int {
	return m.Size()
}
func (m *GetAddressRes) XXX_DiscardUnknown() {
	xxx_messageInfo_GetAddressRes.DiscardUnknown(m)
}

var xxx_messageInfo_GetAddressRes proto.InternalMessageInfo

func (m *GetAddressRes) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (*GetBalanceRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{10}
}
...
func (*GetNetIDRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{11}
}
...
func (*GetStateRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{12}
}
...
func (*SendRawTxRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{13}
}
...
func (*GasRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{14}
}
...
func (*TxRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{15}
}
...
func (*TxReceiptRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{16}
}
...
func (*BlockInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{17}
}
...
func (*SubscribeRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_apis_12d4c592fdeb6b86, []int{18}
}
...
func init() {
	...
	proto.RegisterType((*GetAddressReq)(nil), "rpc.GetAddressReq")
	proto.RegisterType((*GetAddressRes)(nil), "rpc.GetAddressRes")
...
type ApisClient interface {
	...
	GetAddressByPubKey(ctx context.Context, in *GetAddressReq, opts ...grpc.CallOption) (*GetAddressRes, error)
	// get the Net ID
...
func (c *apisClient) GetAddressByPubKey(ctx context.Context, in *GetAddressReq, opts ...grpc.CallOption) (*GetAddressRes, error) {
	out := new(GetAddressRes)
	err := c.cc.Invoke(ctx, "/rpc.Apis/GetAddressByPubKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApisServer interface {
	...
	// get address by pubkey
	GetAddressByPubKey(context.Context, *GetAddressReq) (*GetAddressRes, error)
	// get the Net ID
...
func _Apis_GetAddressByPubKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAddressReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApisServer).GetAddressByPubKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Apis/GetAddressByPubKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApisServer).GetAddressByPubKey(ctx, req.(*GetAddressReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Apis_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAddressByPubKey",
			Handler:    _Apis_GetAddressByPubKey_Handler,
		},
		{
			MethodName: "GetNetID",
...
func (m *GetAddressReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetAddressReq) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.PubKey) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintApis(dAtA, i, uint64(len(m.PubKey)))
...
func (m *GetAddressRes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetAddressRes) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Address) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintApis(dAtA, i, uint64(len(m.Address)))
...
func (m *GetAddressReq) Size() (n int) {
	var l int
	_ = l
	l = len(m.PubKey)
	if l > 0 {
...
func (m *GetAddressRes) Size() (n int) {
	var l int
	_ = l
	l = len(m.Address)
	if l > 0 {
...
func (m *GetAddressReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAddressReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAddressReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetAddressRes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAddressRes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAddressRes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() { proto.RegisterFile("rpc/apis.proto", fileDescriptor_apis_12d4c592fdeb6b86) }

var fileDescriptor_apis_12d4c592fdeb6b86 = []byte{
	// 1039 bytes of a gzipped FileDescriptorProto
	,
}
