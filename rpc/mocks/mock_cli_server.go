...
func (m *MockCliServer) GetContract(arg0 context.Context, arg1 *rpc.ContractKey) (*rpc.Contract, error) {
...
func (mr *MockCliServerMockRecorder) GetContract(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetContract", reflect.TypeOf((*MockCliServer)(nil).GetContract), arg0, arg1)
}
