...
cat iserver.yaml | sed 's/\$COMMIT'"/$NAME/g" | kubectl delete -f - -n $NAME --ignore-not-found
cat itest.yaml | sed 's/\$COMMIT'"/$NAME/g" | kubectl delete -f - -n $NAME --ignore-not-found
