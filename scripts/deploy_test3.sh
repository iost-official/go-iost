...
Tokyo="Tokyo 13.56.255.143 1 "$Port
London="London 18.144.11.65 2 "$Port
Singapore="Singapore 13.57.176.233 3 "$Port
Mumbai="Mumbai 54.183.115.79 4 "$Port
Frankfort="Frankfort 13.56.223.196 5 "$Port
Seoul="Seoul 18.144.42.61 6 "$Port
Montreal="Montreal 13.57.185.234 7 "$Port
