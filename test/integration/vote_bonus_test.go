...
func Test_VoteBonus(t *testing.T) {
	...
	Convey("test vote bonus", t, func() {
		...
		for idx, acc := range testAccounts {
			...
			So(s.Visitor.TokenBalance("contribute", acc.ID), ShouldEqual, int64(328513441*(idx+1)))
		}
		...
		So(s.Visitor.TokenBalance("iost", acc1.ID), ShouldEqual, int64(657026882))
		So(s.Visitor.TokenBalance("iost", "vote_producer.iost"), ShouldEqual, int64(103333333410))
		...
		So(err, ShouldBeNil)
		So(r.Status.Message, ShouldEqual, "")
		So(s.Visitor.TokenBalance("iost", acc1.ID), ShouldEqual, int64(657026882+60606062))                 // 60606062 = (3333333410*(2/55))/2
		...
		So(err, ShouldBeNil)
		So(r.Status.Message, ShouldEqual, "")
		So(s.Visitor.TokenBalance("iost", acc1.ID), ShouldEqual, int64(657026882+60606062)) // not change
		...
		So(s.Visitor.TokenBalance("iost", acc3.ID), ShouldEqual, int64(1314053764))
		So(s.Visitor.TokenBalance("iost", "vote_producer.iost"), ShouldEqual, int64(103242424317))
		...
		So(err, ShouldBeNil)
		So(r.Status.Message, ShouldEqual, "")
		So(s.Visitor.TokenBalance("iost", acc3.ID), ShouldEqual, int64(1314053764+121212124))                // 121212124 = (3333333410*(4/55))/2
		...
		So(err, ShouldBeNil)
		So(r.Status.Message, ShouldEqual, "")
		So(s.Visitor.TokenBalance("iost", acc3.ID), ShouldEqual, int64(1314053764+121212124)) // not change
