...
func Test_Vote1(t *testing.T) {
	...
	Convey("test Vote", t, func() {
		...
		Convey("test vote/unvote", func() {
			...
			So(err, ShouldBeNil)
			So(r.Status.Code, ShouldEqual, tx.Success)
			So(r.Returns[0], ShouldEqual, fmt.Sprintf(`["{\"pubkey\":\"%s\",\"loc\":\"loc\",\"url\":\"url\",\"netId\":\"netId\",\"online\":true,\"registerFee\":\"200000000\",\"voteInfo\":{\"votes\":\"300000000\",\"deleted\":false,\"clearTime\":-1}}"]`, acc6.KeyPair.ReadablePubkey()))
...
func Test_Vote2(t *testing.T) {
	...
	Convey("test Vote2", t, func() {
		...
		Convey("test new vote/unvote", func() {
			s.Head.Number = 1
			r, err := s.Call("vote_producer.iost", "ApplyRegister", fmt.Sprintf(`["%v", "%v", "loc", "url", "netId"]`, acc6.ID, acc6.KeyPair.ReadablePubkey()), acc6.ID, acc6.KeyPair)
			So(err, ShouldBeNil)
			So(r.Status.Message, ShouldEqual, "")
			So(r.Status.Code, ShouldEqual, tx.Success)
			...
			So(r.Status.Message, ShouldEqual, "")
			So(r.Status.Code, ShouldEqual, tx.Success)
			r, err = s.Call("vote_producer.iost", "ApplyRegister", fmt.Sprintf(`["%v", "%v", "loc", "url", "netId"]`, acc7.ID, acc7.KeyPair.ReadablePubkey()), acc7.ID, acc7.KeyPair)
			So(err, ShouldBeNil)
			So(r.Status.Message, ShouldEqual, "")
			So(r.Status.Code, ShouldEqual, tx.Success)
			...
			So(r.Status.Message, ShouldEqual, "")
			So(r.Status.Code, ShouldEqual, tx.Success)
			r, err = s.Call("vote_producer.iost", "ApplyRegister", fmt.Sprintf(`["%v", "%v", "loc", "url", "netId"]`, acc8.ID, acc8.KeyPair.ReadablePubkey()), acc8.ID, acc8.KeyPair)
			So(err, ShouldBeNil)
			So(r.Status.Message, ShouldEqual, "")
			So(r.Status.Code, ShouldEqual, tx.Success)
			...
			So(err, ShouldBeNil)
			So(r.Status.Code, ShouldEqual, tx.Success)
			So(r.Returns[0], ShouldEqual, fmt.Sprintf(`["{\"pubkey\":\"%s\",\"loc\":\"loc\",\"url\":\"url\",\"netId\":\"netId\",\"status\":1,\"online\":true,\"voteInfo\":{\"votes\":\"300000000\",\"deleted\":false,\"clearTime\":-1}}"]`, acc6.KeyPair.ReadablePubkey()))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 8, 6, 0, 3, 1, 4
			pendingList, _ = json.Marshal([]string{acc8.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc3.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 7, 8, 6, 0, 3, 1
			pendingList, _ = json.Marshal([]string{acc7.KeyPair.ReadablePubkey(), acc8.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc3.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 2, 7, 8, 6, 0, 3
			pendingList, _ = json.Marshal([]string{acc2.KeyPair.ReadablePubkey(), acc7.KeyPair.ReadablePubkey(), acc8.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc3.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 2, 7, 4, 8, 6, 0
			pendingList, _ = json.Marshal([]string{acc2.KeyPair.ReadablePubkey(), acc7.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey(), acc8.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 2, 1, 7, 4, 8, 6
			pendingList, _ = json.Marshal([]string{acc2.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc7.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey(), acc8.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 3, 2, 1, 7, 4, 8
			pendingList, _ = json.Marshal([]string{acc3.KeyPair.ReadablePubkey(), acc2.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc7.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey(), acc8.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 3, 2, 1, 7, 6, 4
			pendingList, _ = json.Marshal([]string{acc3.KeyPair.ReadablePubkey(), acc2.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc7.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
...
func Test_Unregister2(t *testing.T) {
	...
	Convey("test Unregister2", t, func() {
		...
		Convey("test new Unregister", func() {
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 9, 0, 3, 1, 4, 5
			pendingList, _ := json.Marshal([]string{acc9.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc3.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey(), acc5.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 8, 9, 0, 3, 1, 4
			pendingList, _ = json.Marshal([]string{acc8.KeyPair.ReadablePubkey(), acc9.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc3.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 7, 8, 0, 3, 1, 4
			pendingList, _ = json.Marshal([]string{acc7.KeyPair.ReadablePubkey(), acc8.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc3.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 6, 7, 5, 0, 1, 4
			pendingList, _ = json.Marshal([]string{acc6.KeyPair.ReadablePubkey(), acc7.KeyPair.ReadablePubkey(), acc5.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 2, 6, 7, 5, 0, 1
			pendingList, _ = json.Marshal([]string{acc2.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey(), acc7.KeyPair.ReadablePubkey(), acc5.KeyPair.ReadablePubkey(), acc0.KeyPair.ReadablePubkey(), acc1.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
			...
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-currentProducerList")), ShouldEqual, string(currentList))
			// 2, 9, 8, 4, 3, 6
			pendingList, _ = json.Marshal([]string{acc2.KeyPair.ReadablePubkey(), acc9.KeyPair.ReadablePubkey(), acc8.KeyPair.ReadablePubkey(), acc4.KeyPair.ReadablePubkey(), acc3.KeyPair.ReadablePubkey(), acc6.KeyPair.ReadablePubkey()})
			So(database.MustUnmarshal(s.Visitor.Get("vote_producer.iost-pendingProducerList")), ShouldEqual, string(pendingList))
		})
	})
}
