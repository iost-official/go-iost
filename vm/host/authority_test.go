...
func TestRequireAuth_ByKey(t *testing.T) {
	...
	db.EXPECT().Get("state", "b-auth.iost@a-auth").DoAndReturn(func(a, b string) (string, error) {
...
func TestAuthority_ByUser(t *testing.T) {
	...
	db.EXPECT().Get("state", "b-auth.iost@b-auth").DoAndReturn(func(a, b string) (string, error) {
