...
// Source: github.com/iost-official/prototype/state (interfaces: StatePool)

// Package state_mock is a generated GoMock package.
package core_mock
...
// MockPool is a mock of StatePool interface
...
func (m *MockPool) Copy() state.StatePool {
