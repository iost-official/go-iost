...
var file_core_block_pb_block_proto_goTypes = []any{
...
func file_core_block_pb_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_block_pb_block_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_core_block_pb_block_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Block); i {
			case 0:
				return &v.state
			case 1:
