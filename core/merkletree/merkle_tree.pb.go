...
var file_core_merkletree_merkle_tree_proto_goTypes = []any{
...
func file_core_merkletree_merkle_tree_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_merkletree_merkle_tree_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_core_merkletree_merkle_tree_proto_msgTypes[1].Exporter = func(v any, i int) any {
